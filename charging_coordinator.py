...
class ChargingCoordinator:
    ...
    def is_charger_available(self, charger_name: str) -> bool:
        return (
            charger_name not in self.charging_stations
            and charger_name not in self.reservations
        )
    ...
    def start_charging(self, charger_name: str, robot_name: str) -> bool:
        if (
            charger_name in self.reservations
            and self.reservations[charger_name] == robot_name
        ):
    ...
    def stop_charging(self, charger_name: str, robot_name: str) -> bool:
        if (
            charger_name in self.charging_stations
            and self.charging_stations[charger_name] == robot_name
        ):
